              ...
              <div>
                ...
                <div style={{border: "5px solid lemonchiffon",height: "25em", width: "25em", borderRadius: "50%", marginTop: "2em", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
                  ...
                  <div style={{minWidth: 150, display: "flex", justifyContent: "space-between"}}>
                    <button style={{width: "fit-content", fontSize: "1.15rem", marginTop: 10, borderRadius: 10, padding: 5, border: "none"}}>Start</button>
                    <button style={{width: "fit-content", fontSize: "1.15rem", marginTop: 10, borderRadius: 10, padding: 5, border: "none"}}>Reset</button>
                  </div>
                </div>
              </div>
            </Route>
